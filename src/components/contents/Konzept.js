  ...
  return (
    <div id="konzept" className="all-center">
      ...
      <p>
        ...
        unser Gefühl von Gemaitlichkeit mit euch teilen können. Wir sind super
        neugierig, was sich mit der Zeit noch aus unserem Projekt entwickelt.
        Wenn ihr Ideen, Anregungen, Projekte, habt: wir freuen uns über jede Art
        von Feedback! Es geht los! Und wir sind ganz schön aufgeregt. Unsere
        vielen, stundenlangen Träumereien und Ideen beginnen ganz langsam
        Realität zu werden.
      </p>
    </div>
  );
