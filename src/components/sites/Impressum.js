...
const Impressum = () => {
  ...
  return (
    <div style={{ display: "flex", backgroundColor: "var(--light-color)" }}>
      <div style={styleDiv}>
        <h1 className="headings text-left">
          <strong>I</strong>mpressum
        </h1>
        <div
          className={
            screenWidth > 1000 ? "text-left middle" : "text-left small"
          }
        >
          ...
          <h3 style={styleParts}>Kontakt</h3>
          <p>
            Telefon: +49 172 4172082
            <br />
            E-Mail: eicke@rondio.net
            <br />
            <a href="https://rondio.net">https://rondio.net</a>
          </p>
          <h3 style={styleParts}>Haftung f&uuml;r Inhalte</h3>
          <p>
          ...
          <h3 style={styleParts}>Haftung f&uuml;r Links</h3>
          <p>
          ...
          <h3 style={styleParts}>Urheberrecht</h3>{" "}
          <p>
